...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "The system that makes industrial-scale mud crab production possible.",
    url: "https://crabionics.com",
    siteName: "Crabionics",
    type: "website",
    images: [{ url: "/infrastructure.png", width: 1200, height: 630, alt: "Crabionics production infrastructure" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Crabionics | Production Architecture for Mud Crab Aquaculture",
    description: "Modular RAS, AquaOS, and closed-loop control for industrial mud crab production.",
    ...
    <ClerkProvider>
      <html lang="en" suppressHydrationWarning className={instrumentSerif.variable}>
        <body>
          ...
          <Navbar />
          <main className="relative z-10 pt-20 min-h-screen overflow-hidden">{children}</main>
          <Footer />
        </body>
      </html>
    </ClerkProvider>
