...
1. Homepage "What's real today" proof-of-operation strip (existing card style), three proven assets stated *directionally* in public: "hundreds of individually-tracked crabs" across soft-shell/hard-shell/RAS trials; molt-driven grade uplift ("demonstrated meaningful grade uplift in early field work"); live export & retail market linkage. The precise figures (exact crab count, ~3–4.6× per-unit value) live in the data room beside their caveats — same logic as the patent count: exact numbers in public copy are a liability, not an asset. Placed *before* the architecture so proof-of-operation leads. Plus a closing bridge line before the final CTA: "The 600-box pilot is the bridge — from operational intelligence to provable industrial causality."
