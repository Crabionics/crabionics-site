    ...
    <main className="bg-neutral-50 text-neutral-900">
      ...
      <section className="py-16 md:py-20 px-6 border-b border-neutral-200 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 rounded border border-neutral-300 bg-neutral-100 p-5 text-sm text-neutral-700">
      ...
      <section className="py-16 px-6 border-t border-neutral-200 bg-white">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-4">
          <Link href="/technology" className="px-6 py-3 border border-neutral-300 text-sm font-medium hover:bg-neutral-100">
