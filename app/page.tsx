    ...
    <main className="relative overflow-hidden">
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex min-h-screen items-center">
          ...
          <div className="container-shell py-32">
            ...
            >
              ...
              {/* EYEBROW */}
              <div className="mb-6 inline-flex items-center rounded-full border border-cyan-400/20 bg-cyan-400/10 px-5 py-2 text-xs uppercase tracking-[0.24em] text-cyan-200 backdrop-blur-md">
                Precision Aquaculture Infrastructure
              </div>

              {/* HEADLINE */}
              <h1 className="max-w-5xl text-5xl font-semibold leading-[0.95] tracking-[-0.04em] text-white sm:text-6xl lg:text-7xl">
